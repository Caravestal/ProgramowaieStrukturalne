...
void sum(int n,int tab1[],int tab2[],int tab3[])
{
    for(int i=0;i<n;i++)
...
int main()
{
    ...
    int tab4[]={1,2,3,4,5},tab5[]={6,7,8,9,10},tab6[]={11,12,13,14,15}; // Tu 4,5,6 ponieważ potrzebowałam znowu wartości początkowych
